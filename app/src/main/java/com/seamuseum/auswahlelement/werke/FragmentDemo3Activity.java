...
public class FragmentDemo3Activity extends Activity
{
    ...
    public static class AuswahlFragment extends ListFragment
    {
        ...
        public void onActivityCreated(Bundle savedInstanceState)
        {
            ...
            String a1 = getString(R.string.werk1);
            String a2 = getString(R.string.werk2);
            String a3 = getString(R.string.werk3);
            String a4 = getString(R.string.werk4);
            String a5 = getString(R.string.werk5);
             ...
             *  Aktiviert die Spaltenansicht in der land-view (zur Zeit in "Werke")
             */
