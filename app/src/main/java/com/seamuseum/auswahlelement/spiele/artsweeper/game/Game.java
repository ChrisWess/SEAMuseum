...
import com.seamuseum.auswahlelement.spiele.artsweeper.board.BoardSquare;
import com.seamuseum.auswahlelement.spiele.artsweeper.board.TileView;
import com.seamuseum.auswahlelement.spiele.artsweeper.exceptions.InitializationException;
...
public class Game {
    ...
    private void init() {
        ...
        GameBus.getGameBus().register(this);
    ...
    public void unregisterFromEventBus() {
        GameBus.getGameBus().unregister(this);
    }
